...
Xcode 27 also introduces an MCP server. This is important because MCP is not limited to the built-in Xcode experience. External agents can connect to Xcode from outside the app, inspect project state, and use Xcode as part of a broader agentic development workflow.
